        ...
        private fun setPaintFlagAndColor(binding: ShopListItemBinding) {
            binding.apply {
                if (chBox.isChecked) {
                    ...
                    tvName.setTextColor(ContextCompat.getColor(binding.root.context, R.color.gray_picker))

                    tvInfo.paintFlags = Paint.STRIKE_THRU_TEXT_FLAG
                    tvInfo.setTextColor(ContextCompat.getColor(binding.root.context, R.color.gray_picker))
                } else {
